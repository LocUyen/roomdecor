    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="paging-wp">
                ...
                <p id="desc" class="fl-left font-weight-normal text-dark">Có <?php echo$num_rows; ?> bài viết</p>
                    
                    <?php 
                        echo get_pagging($num_page, $page, $base_url="?mod=posts&controller=index&active=index");
                    ?>
                </div>
            </div>
        </div>
