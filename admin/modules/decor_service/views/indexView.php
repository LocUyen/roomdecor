    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách đội ngũ decor</h3>
                </div>
            </div>
                        ...
                        <table class="table list-table-wp">
                            <thead>
                                <tr>
                                    ...
                                    <td><span class="thead-text">Tên đội ngũ</span></td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <p id="desc" class="fl-left">Có <?php echo $num_rows; ?> bài đăng về đội ngũ decor</p>
