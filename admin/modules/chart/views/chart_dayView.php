...
<body>
    ...
    <!-- <div class="float-right mt-5 mr-5 inline-bl">
        ...
        <button class="btn btn-primary ml-2"><a href="?mod=chart&action=chart_month&month=12" class="text-light">Tháng</a></button>
    ...
    <div class="float-right mt-5 mr-5 inline-bl">
        <form action="?mod=chart" method="get">
            ...
            <input type="hidden" name="action" value="chart_day">
  ...
  series: [{
    ...
    data: [
        ...
        foreach($money as $a){
        ?>
        ['<?php echo json_encode($a['ngay']); ?> h', <?php echo $a['doanh_thu']; ?>],
        <?php    
        }
        ?>
