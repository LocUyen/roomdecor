        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=suppliers&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        ...
                        <form method="GET" class="form-s fl-right">
                            <input type="hidden" value="suppliers" name="mod">
                        ...
                        <table class="table list-table-wp">
                            <thead>
                                <tr>
                                    ...
                                    <td><span class="thead-text" style="width:200px;">Địa chỉ</span></td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="tb-title tbody-text" style="width:200px;"><?php echo $item['supplier_address']; ?></span></td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <p id="desc" class="fl-left">Có <?php echo $num_rows; ?> nhà cung cấp</p>
