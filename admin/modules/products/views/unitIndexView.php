    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh mục đơn vị sản phẩm</h3>
                    <a href="?mod=products&controller=unit&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <!-- <td><span class="tbody-text"><?php echo $item['unit_id']; ?></h3></span> -->
                                    <td class="clearfix">
                                        <div class="tb-title fl-left">
                                            <a href="" title=""><?php echo $item['unit_name']; ?></a>
                                        </div> 
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <p id="desc" class="fl-left">Có <?php echo $num_rows; ?> đơn vị sản phẩm</p>
