    ...
    <div class="wp-inner">
        <div class="main-content fl-right">
            ...
            <div class="section" id="list-product-wp">
                <?php
                foreach($get_list_cate as $cate){
                ?>
                <div class="section-head">
                    <h3 class="section-title"><?php echo $cate['product_cate_title']; ?></h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <?php
                        ...
                        foreach($get_list_product as $product){
                            if($cate['product_cate_id'] == $product['product_cate_id']){
                        ?>
                        <li>
                            <a href="<?php echo $product['url_detail']; ?>" title="" class="thumb">
                                <img src="admin/public/uploads/<?php echo $product['product_image']; ?>" style="height: 189px; margin-left:auto; margin-right:auto;">
                            </a>
                            <a href="<?php echo $product['url_detail']; ?>" title="" class="product-name" style="display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;overflow: hidden;"><?php echo $product['product_title']; ?></a>
                            <div class="price">
